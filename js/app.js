document.addEventListener('DOMContentLoaded',() =>{
    ...
    (function(index){
        ...
        squares[i].onclick = function(){
            //if the square below ur current square is taken, you can go ontop of it
            if (squares[index + 7].classList.contains('taken')){
                ...
                //if the square below ur current square is not taken, you cant go here
    ...
    //add an eventListener to each square triggering the checkboard function on click
